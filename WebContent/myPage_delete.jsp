	...
	<div class="d-flex" id="wrapper">
		...
		<div class="bg-light border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
				...
				<a href="#" class="list-group-item list-group-item-action bg-light">회원탈퇴</a>
			</div>
			<%}else { %>
			<!-- 단체회원 sidebar -->
			<h3
            ...
            <div class="list-group list-group-flush">
				<a href="myPage_info.jsp" class="list-group-item list-group-item-action bg-light">회원정보 변경</a>
				<a href="#" id="memberDelete" class="list-group-item list-group-item-action bg-light">회원탈퇴</a>
			</div>
			<%} %>
		</div>
		<!-- /sidebar -->
