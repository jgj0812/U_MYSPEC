	...
	<div class="reply" style="background-color:#eeeeee;">
		...
		<div class="reply_div">
			...
			<div id="basic<%=i%>" style="display: block"> 
		        ...
		        <div>
		            ...
		            <!-- 일반회원일때 member 0 id = id.trim().equals(actRB.getRep_person())
		                ...
		                <!-- 삭제  -->
		                <form action="../activity/list_actreply_deletePro.jsp"> 
		                    <!-- 원래글로 돌아가기위한 글번호  -->
		    ...
		    <div id="update<%=i %>" style="display: none">
		        <form action ="../activity/list_actreply_updatePro.jsp" method="post" id="reply_update<%=i %>"> 
		    ...
		    <div id="rereply<%=i%>" style="display: none">
		        <form action="../activity/list_act_replyPro.jsp" id="rereplyFrm<%=i %>" name="comm_rereply_form" method="post">
		            <input type="hidden" name="act_num" value="<%= act_num%>">
		    ...
		    <div id="rereupdate<%=actRB2.getRep_num() %>" style="display: none">
		        <form action ="../activity/list_actreply_updatePro.jsp" method="post" id="rereply_update<%=actRB2.getRep_num() %>"> 
		            <div style="margin-bottom: 5px">
		...
		<!-- ----------------------댓글 입력폼--------------------- -->
		 <%
	        if(id != null) {
	    %>				
	    <form action="../activity/list_act_replyPro.jsp" id="replyFrm" name="comm_reply_form" method="post">
	        <!-- 글번호 -->
	        <input type="hidden" name="act_num" value="<%= act_num%>">
	        <!-- 부모댓글번호 -->
