<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="container">
      ...
      <nav class="navbar">
          ...
          <button
            class="p-4 col-lg-4 text-center border border-primary d-none d-lg-table-cell"
            type="button"
          >
            전체
          </button>
      ...
      <!-- navbar -mobile- -->
        <nav class="navbar d-block d-sm-none  ">
          ...
          <button
            class="p-2 col-3 text-center border border-primary "
            type="button"
          >
            <small>전체</small>
          </button>
          <button
          class="p-2 col-4 text-center border border-primary"
          type="button"
          >
          <small>모집중인 활동 </small>
          </button>
              ...
              <tbody>
                <tr class="d-flex">
                  ...
                  <td class="col-md-5">
                    ...
                    <a href="detailView.jsp" class="d-block d-sm-none">검색 결과로 나온 대외활동의 제목입니다(mobile).</a>
                ...
                <tr class="d-flex">
                  ...
                  <td class="col-md-5">
                    ...
                    <a href="detailView.jsp" class="d-block d-sm-none">제목(mobile)</a>
                    <p class="d-block d-sm-none">
                      <small>글쓴이 등록일 조회수</small>
                    </p>
                  </td>
                ...
                <tr class="d-flex">
                  ...
                  <td class="col-md-5">
                    ...
                    <a href="detailView.jsp" class="d-block d-sm-none">제목이 제법 긴 대외활동 & 대외활동 대외활동(mobile)</a>
                    <p class="d-block d-sm-none">
                      <small>글쓴이 등록일 조회수</small>
                    </p>
                  </td>
                ...
                <tr class="d-flex">
                  ...
                  <td class="col-md-5">
                    ...
                    <a href="detailView.jsp" class="d-block d-sm-none">공모전 제목(mobile)</a>
                    <p class="d-block d-sm-none">
                      <small>글쓴이 등록일 조회수</small>
                    </p>
                  </td>
                ...
                <tr class="d-flex">
                  ...
                  <td class="col-md-5">
                    ...
                    <a href="detailView.jsp" class="d-block d-sm-none">제4회 MYSPEC 포스터 공모전(mobile)</a>
                    <p class="d-block d-sm-none">
                      <small>글쓴이 등록일 조회수</small>
                    </p>
                  </td>
