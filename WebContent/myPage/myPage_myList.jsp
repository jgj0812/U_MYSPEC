				...
				<div class="table-responsive">
					<table class="table table-sm table-hover">
						<thead>
					 	...
					 	<tbody>
<%
						for(CommunityBean commB : myListArr){
					...
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							...
							// 총 페이지 수 구하기, 전체 글개수 나누기 페이지사이즈(한 화면에 보여지는 수)
								...
								%>	
							    	<li class="page-item">
							      		<a class="page-link" href="myPage_myList.jsp?pageNum=<%=startPage - pageBlock%>&keyWord=<%=keyWord%>&keyField=<%=keyField%>" aria-label="Previous">
							    ...
							    %>
							    	<li class="page-item">
							    		<a class="page-link text-dark" href="myPage_myList.jsp?pageNum=<%= i %>&keyWord=<%=keyWord%>&keyField=<%=keyField%>">
							    			<%= i %>
							    		</a>
							    	</li>
							    <%
							    ...
							    %>
							    	<li class="page-item">
							      		<a class="page-link" href="myPage_myList.jsp?pageNum=<%=startPage + pageBlock%>&keyWord=<%=keyWord%>&keyField=<%=keyField%>" aria-label="Next">
