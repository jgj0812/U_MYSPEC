					...
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							...
							// 총 페이지 수 구하기, 전체 글개수 나누기 페이지사이즈(한 화면에 보여지는 수)
								...
								%>	
							    	<li class="page-item">
							      		<a class="page-link" href="myPage_myList.jsp?pageNum=<%=startPage - pageBlock%>" aria-label="Previous">
							    ...
							    %>
							    	<li class="page-item">
							    		<a class="page-link text-dark" href="myPage_myList.jsp?pageNum=<%= i %>">
							    			<%= i %>
							    		</a>
							    	</li>
							    <%
							    ...
							    %>
							    	<li class="page-item">
							      		<a class="page-link" href="myPage_myList.jsp?pageNum=<%=startPage + pageBlock%>" aria-label="Next">
