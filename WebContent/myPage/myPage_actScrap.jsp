...
<%
	...
	ArrayList<ActivityBean> actScrapArr = mgr.actScrapList(startRow, endRow, id);
					...
					<nav aria-label="Page navigation example">
						...
						<%	if(count > 0) { 	
								...
								int endPage = startPage + pageBlock - 1;				
							    	...
							    	<li class="page-item">
							      		<a class="page-link" href="myPage_actScrap.jsp?pageNum=<%=startPage - pageBlock%>" aria-label="Previous">
							    ...
							    %>
							    	<li class="page-item">
							    		<a class="page-link text-dark" href="myPage_actScrap.jsp?pageNum=<%= i %>">
							    			<%= i %>
							    		</a>
							    	</li>
							    <%
							    ...
							    %>
							    	<li class="page-item">
							      		<a class="page-link" href="myPage_actScrap.jsp?pageNum=<%=startPage + pageBlock%>" aria-label="Next">
